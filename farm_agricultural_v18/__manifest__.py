# -*- coding: utf-8 -*-
{
    'name': "Módulo Agrícola - Gestión de Campañas (V18 Cache Bypass)",
    'summary': """
        Extensión del módulo de fabricación para gestionar campañas agrícolas completas - Versión Odoo 18
    """,
    'description': """
        Módulo Agrícola - Gestión de Campañas (Versión Odoo 18)
        ====================================
        
        Este módulo extiende el sistema de fabricación de Odoo para adaptarlo
        a la gestión de campañas agrícolas con plena compatibilidad Odoo 18:
